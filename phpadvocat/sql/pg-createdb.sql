...
create table phpa_pfiles (
  ...
  partner integer,
  opposing integer,
  opposing_rep integer,
  court integer,
  createdate date,
  enddate date,
  endnumber varchar(30),
  comment varchar(512),
...
-- all documents are stores into the database in order to keep all things together in one place
...
create table phpa_config (
  ...
  pdf_command   varchar(200),
  invoice_base  integer,
