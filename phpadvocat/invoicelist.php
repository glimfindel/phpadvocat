...
/* This query only shows invoices with at least one position */
/*
$querystring = 
...
$querystring = 
  ...
  "p.subject as subject, " .
  "i.createdate as createdate, ".
  "sum(phpa_invoicepos.amount)+sum(phpa_invoicepos.vat) as sum ".
  "from phpa_pfiles p, phpa_invoices i ".
  "left outer join phpa_invoicepos on " .
     "phpa_invoicepos.invoice=i.number ".
  "where p.number=i.pfile ".
  "and i.paydate is null ".
  "group by i.number, p.processregister, p.subject, i.createdate ";
